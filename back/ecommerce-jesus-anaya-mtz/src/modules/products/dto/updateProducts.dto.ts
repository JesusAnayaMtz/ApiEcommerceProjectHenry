...
export class UpdateProductDto extends PartialType(CreateProductDto) {
      ...
      @ApiProperty({
        description: 'El Nombre del producto máximo 50 caracteres.',
      ...
      @ApiProperty({
        description: 'El precio debe ser un número positivo y con máximo 2 decimales.',
        example: 15999.50,
      })
      ...
      @ApiProperty({
        description: 'El stock debe ser un número entero igual o mayor a 0.',
        example: 25,
      })
